...
async function startServer() {
  ...
  if (process.env.NODE_ENV !== "production") {
    ...
    // Important: Express v5 uses *all instead of * for catch-all if using new routing, but * is still mostly supported, let's use *all to be safe or just a middleware
